...
const CartLeftPart = () => {
  ...
  return (
      <div className=''>
        <div className=''>
            <div className='bg-white py-6 rounded-lg lg:rounded-none'>
                <p className='px-12 text-gray-500 font-bold font-DM_Sans text-lg lg:text-left text-center'>Delivery address</p>
                <span className='absolute -mt-8 lg:-ml-4 ml-3 bg-white p-[10px] text-xl shadow-lg shadow-gray-400 '>
                    <GoLocation />
                </span>
            </div>

            <div className=' mt-5  bg-[#F8F8FD] '>
              <div className="lg:w-[770px] sm:w-full py-4 lg:px-4 px-5 rounded-lg flex flex-col sm:flex-col">
                  ...
                  <div className="flex flex-col">
                      ...
                      id="Name"
                      placeholder="Name"
                      className={`pl-2 border-2 border-slate-200 lg:w-[336px] w-full py-3 rounded-xl${
                  ...
                  <textarea
                      ...
                      className="pl-2 rounded-xl py-2 border-2 h-32  w-full"
